...
import { CREATE_RESTAURANT_REQUEST, CREATE_RESTAURANT_SUCCESS, DELETE_RESTAURANT_FAILURE, DELETE_RESTAURANT_REQUEST, DELETE_RESTAURANT_SUCCESS, GET_ALL_RESTAURANTS_FAILURE, GET_ALL_RESTAURANTS_REQUEST, GET_ALL_RESTAURANTS_SUCCESS, GET_RESTAURANT_BY_ID_FAILURE, GET_RESTAURANT_BY_ID_REQUEST, GET_RESTAURANT_BY_ID_SUCCESS, UPDATE_RESTAURANT_FAILURE, UPDATE_RESTAURANT_REQUEST, UPDATE_RESTAURANT_SUCCESS } from "./ActionTypes";
...
export const createRestaurant = (reqData) => {
  ...
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("catch error ", error);
      dispatch({type:CREATE_RESTAURANT_SUCCESS,payload:error});
    }
  };
};
...
export const deleteRestaurant = ({ restaurantId, jwt }) => {
  return async (dispatch) => {
    ...
    try {
      ...
      console.log("catch error ", error);
      dispatch({type:DELETE_RESTAURANT_FAILURE});
    }
  };
};
